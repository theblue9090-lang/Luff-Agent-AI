...
export const FALLBACK_COINS: Coin[] = [
  ...
  m('base', 'base', 'aerodrome', 'Crimson Base', 'CRBASE', 0.1183, 1.4, 3.9, 14.6, 2_960_000, 410_000, 8_700_000, now - 54 * H, false),
  m('eth-1', 'ethereum', 'uniswap', 'Vermilion', 'VRM', 0.5562, 0.8, -2.1, 6.4, 5_200_000, 1_100_000, 44_100_000, now - 168 * H, false),
